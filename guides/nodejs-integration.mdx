---
title: "Node.js Integration with XPayLabs Node.js SDK"
sidebarTitle: "Node.js Integration"
description: "Integrate crypto payments into your Node.js application using the official @xpaylabs/node-sdk package. Includes npm setup, configuration, webhook handling, and full API examples."
---

The XPayLabs Node.js SDK (`@xpaylabs/node-sdk`) provides typed API bindings for TypeScript and JavaScript applications. Source code: [https://github.com/yan253319066/XPayLabs-node-sdk](https://github.com/yan253319066/XPayLabs-node-sdk)
...
| `baseUrl` | No | `https://api.xpaylabs.com` | Gateway base URL |
