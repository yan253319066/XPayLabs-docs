---
title: "Spring Boot Integration with XPayLabs Java SDK"
sidebarTitle: "Spring Boot Integration"
description: "Integrate crypto payments into your Spring Boot application using the official XPayLabs Java SDK. Includes Maven setup, configuration, webhook handling, and full API examples."
---

The XPayLabs Java SDK (`xpay-java-sdk`) provides a comprehensive client for the XPayLabs API, designed to work seamlessly with Spring Boot applications. Source code: [https://github.com/yan253319066/XPayLabs-java-sdk](https://github.com/yan253319066/XPayLabs-java-sdk)
