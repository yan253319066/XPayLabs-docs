---
title: "Send Crypto Payouts with XPayLabs Payout Orders"
sidebarTitle: "Payouts"
description: "Learn how to send crypto payments from your gateway wallet to external blockchain addresses using the XPayLabs payout API."
---
