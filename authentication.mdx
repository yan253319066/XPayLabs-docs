---
title: "HMAC-SHA256 Authentication: XPayLabs API Security"
sidebarTitle: "Authentication"
description: "XPayLabs authenticates every API request with HMAC-SHA256 request signing. Compute the sign field with your merchant token for secure crypto payment API calls."
keywords: ["HMAC-SHA256 authentication", "crypto API security", "merchant token signing", "request signature verification", "anti-replay API", "XPayLabs API authentication"]
---
